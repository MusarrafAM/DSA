//! ### 1. **`toFixed()`** = formatting (returns string)
// Formats a number using fixed-point notation.

// let num = 123.456;
// console.log(num.toFixed(2)); // "123.46"

//! ### 2. **`toPrecision()`** = formatting (returns string)
...
// ==============================================================================================
// Number instance methods – methods you can call on number variables or objects:
// toFixed()
// toPrecision()
// toString()
// valueOf()

// Number static methods – methods on the Number object itself:
// Number.isInteger()
// Number.isNaN()
// Number.isFinite()
// Number.parseInt()
...
// Math object methods – part of the Math object, not Number itself:
// Math.round()
// Math.floor()
// Math.ceil()
// Math.random()
